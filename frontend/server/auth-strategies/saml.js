...
/**
 * Use claims to determine the role of the user instead of having it managed in selekt.
 *
 * @param {import('passport-saml').Profile} p
 */
...
function enableSaml(config) {
  if (config.samlAuthConfigured()) {
    ...
    /**
     * It is best to keep this 'editor' and use claims to manage admin role for selekt.
     * @type string
     */
