...
import { useDarkMode } from '../stores/editor-store';
...
import EditorPaneChatSidebar from './EditorPaneChatSidebar';
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', flexGrow: 1 }}>
        <EditorPaneChatSidebar queryId={queryId}>
