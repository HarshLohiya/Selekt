  ...
  return (
    <div>
      ...
      >
        ...
        <a
          href="https://github.com/selekt/selekt/issues"
          target="_blank"
          rel="noopener noreferrer"
          style={LINK_STYLE}
        >
        ...
        <a
          href="https://github.com/selekt/selekt/blob/master/CHANGELOG.md"
          target="_blank"
          rel="noopener noreferrer"
          style={LINK_STYLE}
        >
        ...
        <a
          href="https://github.com/selekt/selekt"
          target="_blank"
          rel="noopener noreferrer"
          style={LINK_STYLE}
        >
